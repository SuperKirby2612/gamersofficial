...
module.exports = (client, instance, message, args) => {
    client.on("guildCreate", function (guild) {
        const joinembed = new Discord.MessageEmbed()
            ...
            .addFields({
                name: 'Introduction',
                value: 'I see you have made the smart choice to invite me to your server! To start, try saying -g help for a list of commands! Also all jokes aside, thanks for adding this bot!'
            }, {
...
module.exports.config = {
    displayName: 'guildjoin', // Can be changed any time
    dbName: 'guildjoin', // DO NOT CHANGE!
    loadDBFirst: true,
}